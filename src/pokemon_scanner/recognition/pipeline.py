...
class RecognitionPipeline:
    def __init__(self, database=None, pokemontcg_api_key: str = "") -> None:
    ...
    def scan_image(self, image_path: str | Path, language: str = "", zone: tuple[float, float, float, float] | None = None) -> tuple[list[CardCandidate], str]:
        ...
        *raw_ocr_text* is the raw text read by OCR before translation.
        ...
        from src.pokemon_scanner.datasources.name_translator import correct_ocr_pokemon_name, correct_raw_for_search
        if raw_query:
        ...
        if query:
            ...
            if candidates:
                ...
                return self.matcher.rerank_by_language(ranked, language), warp_str, raw_query
        ...
        if card_number:
            ...
            for num in variants:
                ...
                if candidates:
                    return self.matcher.rank(candidates, query=query), warp_str, raw_query
    ...
    def search_by_name(self, query: str, language: str = "") -> list[CardCandidate]:
        ...
        """
        from src.pokemon_scanner.datasources.name_translator import correct_ocr_pokemon_name
        ...
        return self.matcher.rerank_by_language(ranked, language)
